              ...
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex gap-2">
                    <button 
                      disabled
                      className="p-2 bg-gray-300 dark:bg-gray-700 text-gray-500 dark:text-gray-500 rounded-lg cursor-not-allowed opacity-50"
                    ...
                    <a 
                      ...
                      className="p-2 bg-gradient-to-r from-purple-500 to-indigo-500 text-white rounded-lg hover:from-purple-600 hover:to-indigo-600 transition-all hover:scale-105"
              ...
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex gap-2">
                    ...
                    <a 
                      href="https://github.com/Klavadia/mydigitaltwin" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="p-2 bg-gradient-to-r from-purple-500 to-indigo-500 text-white rounded-lg hover:from-purple-600 hover:to-indigo-600 transition-all hover:scale-105"
                      title="View source code on GitHub"
